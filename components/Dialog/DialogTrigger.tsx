...
const ReactPlayer = dynamic(() => import("react-player/lazy"), {
  ssr: false,
  loading: () => (
    <div className='fixed left-1/2 top-1/2 z-10 flex h-full w-full translate-x-[-50%] translate-y-[-50%] animate-pulse items-center justify-center overflow-hidden bg-slate-600'>
